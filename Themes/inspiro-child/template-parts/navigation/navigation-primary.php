<!-- C:\xampp\htdocs\site_curumim\wp-content\themes\inspiro\template-parts\navigationnavigation-primary.php -->
...
$search_show        = get_theme_mod( 'header_search_show', true );
...
<div id="site-navigation" class="navbar">
	<div class="header-inner inner-wrap <?php echo sanitize_html_class( $header_layout_type ); ?> <?php echo sanitize_html_class( $header_menu_style ); ?>">
		...
		<div class="header-widgets-wrapper">
			...
			<!-- ✅ Incluido Botão Doar no navbar -->
			<div class="nav-donate-button">
				<a href="http://localhost/site_curumim/index.php/como-ajudar/">Doar</a>
			</div>
